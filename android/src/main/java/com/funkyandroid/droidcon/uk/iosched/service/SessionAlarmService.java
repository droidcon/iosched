...
public class SessionAlarmService extends IntentService {
    ...
    public static final String ACTION_NOTIFY_SESSION =
            "com.funkyandroid.droidcon.uk.iosched.action.NOTIFY_SESSION";
    public static final String ACTION_SCHEDULE_STARRED_BLOCK =
            "com.funkyandroid.droidcon.uk.iosched.action.SCHEDULE_STARRED_BLOCK";
    public static final String ACTION_SCHEDULE_ALL_STARRED_BLOCKS =
            "com.funkyandroid.droidcon.uk.iosched.action.SCHEDULE_ALL_STARRED_BLOCKS";
    public static final String EXTRA_SESSION_START =
            "com.funkyandroid.droidcon.uk.iosched.extra.SESSION_START";
    public static final String EXTRA_SESSION_END =
            "com.funkyandroid.droidcon.uk.iosched.extra.SESSION_END";
    public static final String EXTRA_SESSION_ALARM_OFFSET =
            "com.funkyandroid.droidcon.uk.iosched.extra.SESSION_ALARM_OFFSET";
    ...
    private void scheduleAlarm(final long sessionStart,
        ...
        notifIntent.setData(
                new Uri.Builder().authority("com.funkyandroid.droidcon.uk.iosched")
